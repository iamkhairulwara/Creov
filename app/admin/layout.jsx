  ...
  return (
    <div className="min-h-screen bg-[#060a1a] text-white selection:bg-cyan-500/30 selection:text-white overflow-x-hidden">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
        <div className="absolute top-0 right-1/4 w-[600px] h-[600px] rounded-full bg-cyan-500/5 blur-[120px] animate-pulse-glow" />
        <div className="absolute bottom-0 left-1/4 w-[500px] h-[500px] rounded-full bg-violet-600/5 blur-[120px] animate-pulse-glow" style={{ animationDelay: '3s' }} />
      </div>

      {/* Cyber Grid Pattern */}
      <div 
        className="absolute inset-0 -z-10 opacity-[0.03] animate-grid-flow"
        style={{
      ...
      <aside className="fixed left-0 top-0 h-full w-64 bg-[#030712]/60 backdrop-blur-xl border-r border-white/5 flex flex-col justify-between z-30">
          ...
          <nav className="space-y-1">
            <Link 
              ...
              className={`flex items-center gap-3 px-4 py-3 rounded-xl text-sm transition-all duration-300 ${
                isActive('/admin') 
                  ? 'bg-gradient-to-r from-cyan-500/10 via-blue-500/5 to-transparent border-l-2 border-cyan-400 text-cyan-300 font-bold shadow-[inset_4px_0_12px_rgba(6,182,212,0.05)]' 
        ...
        <div className="p-6 border-t border-white/5 bg-[#02050f]/20">
          <Link 
            href="/generate"
            className="flex items-center justify-center gap-2 w-full py-2.5 px-4 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 hover:border-white/10 text-xs font-semibold text-slate-300 hover:text-white transition-all duration-300"
          >
