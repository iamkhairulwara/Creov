...
export function buildPrompt(userPrompt, intent) {
  ...
  // Deterministic variety from prompt seed + randomness for diversity
  const seed = hashString(userPrompt + industry + Date.now().toString());
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🎛️ GRAPESJS EDITOR COMPATIBILITY RULES
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

The generated website will be edited inside GrapesJS.
Every visual element must remain independently editable.

1. SECTION ISOLATION

Every major section MUST have a unique ID:
...
Never depend only on shared classes for editable styles.
...
2. BACKGROUND EDITABILITY

The section element itself must control its visible background.
...
where the wrapper controls the background.
...
3. NEVER USE BACKGROUND SHORTHAND
...
The overlay must not prevent GrapesJS from editing the section background.


4. COMPONENT STYLE ISOLATION

Do not create global styles that affect multiple editable components.
...
because changing one component in GrapesJS will affect all similar components.


Instead generate unique selectors:
...
5. UNIQUE IDS FOR EDITABLE ELEMENTS

Important editable elements should have IDs:
...
CSS variables may be used for theme generation, but editable component properties must also exist directly.
...
Each should be selectable and independently editable.


8. WHEN USER CHANGES ONE COMPONENT:
...
Changing About heading color:
→ only About heading changes
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Use CSS variables for initial theme only. Do not create all sections dependent on the same variable. Each section must expose its own editable CSS property.
═══════════════════════════════════════════════════
🚫 ABSOLUTE RULES
═══════════════════════════════════════════════════
