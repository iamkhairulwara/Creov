...
export function buildPrompt(userPrompt, intent) {
  ...
  // ── FINAL PROMPT ─────────────────────────────────────────────────────────
  return `You are a world-class UI/UX designer. Build a STUNNING, PIXEL-PERFECT, FULLY INTERACTIVE single-page website.
...
🚫 ABSOLUTE RULES
═══════════════════════════════════════════════════
1. ❌ NO href="page.html" — ONLY href="#section-id"
2. ✅ ALL content in ONE .html file
3. ✅ HTML starts with <!DOCTYPE html>, ends with </html>
4. ❌ NO Lorem Ipsum — real content only
5. ✅ EVERY card must have class="card" for hover effects

Return ONLY the raw HTML. GO.`;
}