          ...
          {user ? (
            <>
              <div className="flex items-center gap-5 sm:gap-6">
                <Link
                  href="/generate"
                  className={`relative text-xs font-semibold uppercase tracking-wider transition-colors duration-300 flex items-center gap-1.5 ${isActive('/generate') ? 'text-cyan-400' : 'text-slate-400 hover:text-white'
                    }`}
                >
                ...
                <Link
                  href="/templates"
                  className={`relative text-xs font-semibold uppercase tracking-wider transition-colors duration-300 flex items-center gap-1.5 ${isActive('/templates') ? 'text-cyan-400' : 'text-slate-400 hover:text-white'
                    }`}
                >
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                ...
                <Link
                  href="/dashboard"
                  className={`relative text-xs font-semibold uppercase tracking-wider transition-colors duration-300 flex items-center gap-1.5 ${isActive('/dashboard') ? 'text-cyan-400' : 'text-slate-400 hover:text-white'
                    }`}
                >
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
                ...
                {isAdmin && (
                  <Link
                    href="/admin"
                    className={`relative text-xs font-semibold uppercase tracking-wider transition-colors duration-300 flex items-center gap-1.5 ${isActive('/admin') ? 'text-violet-400' : 'text-slate-400 hover:text-white'
                      }`}
                  >
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
